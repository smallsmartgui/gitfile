...
{
  ili9320_DisplayStringLine(Line0, "----------------------------------------",Black,White);
  ili9320_DisplayStringLine(Line1, " ************************************** ",Black,White);
  ili9320_DisplayStringLine(Line2, "                                        ",Black,White);
  ili9320_DisplayStringLine(Line3, "                 WELCOME                ",Black,White);
  ili9320_DisplayStringLine(Line4, "                                        ",Black,White);
	ili9320_DisplayStringLine(Line5, "           THIS IS MY KAIFABAN          ",Black,White);
	ili9320_DisplayStringLine(Line6, "                                        ",Black,White);
	ili9320_DisplayStringLine(Line7, "                                        ",Black,White);
	ili9320_DisplayStringLine(Line8, "                 DESIGNED BY ZHENGW     ",Black,White);
	ili9320_DisplayStringLine(Line9, "                                        ",Black,White);
	ili9320_DisplayStringLine(Line10, "                                        ",Black,White);
	ili9320_DisplayStringLine(Line11, "                                        ",Black,White);
	ili9320_DisplayStringLine(Line12, "                                        ",Black,White);
	ili9320_DisplayStringLine(Line13, " ************************************** ",Black,White);
	ili9320_DisplayStringLine(Line14, "----------------------------------------",Black,White);
}
